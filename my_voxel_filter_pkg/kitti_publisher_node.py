...
class KittiPublisher(Node):
    def __init__(self):
        ...
        self.data_path = os.path.expanduser('/home/suba/my_ros2_ws/src/my_voxel_filter_pkg/KITTI dataset_sequence/2011_09_26/2011_09_26_drive_0009_sync/velodyne_points/data')
    ...
    def timer_callback(self):
        ...
        if pointcloud.shape[0] == 0:
            self.get_logger().warn(f"⚠️ Empty point cloud in: {file}")
            self.index += 1
            return
